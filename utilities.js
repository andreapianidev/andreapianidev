...
// ===== ANDREA AI CHAT WIDGET LOADER =====
// Replaces the legacy floating WhatsApp button and scroll-to-top button.
// The widget integrates both (Call/WhatsApp quick actions inside the chat panel).
(function() {
  if (document.querySelector('script[data-aai-js]')) return;
  const s = document.createElement('script');
  s.src = 'assets/js/chat-widget.js';
  s.defer = true;
  s.setAttribute('data-aai-js', '1');
